  ...
  return (
    <>
      {((showSuggestions && suggestions.length >= 1) || error) && (
        <ul className="font-mono text-2xl  bg-white absolute border top-[70px] left-0 border-gray-300 rounded-md min-w-[200px] max-w-[500px] flex flex-col gap-1 py-2 px-2 z-10">
