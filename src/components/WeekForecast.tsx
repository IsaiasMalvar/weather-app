...
const WeekForecast = ({
  ...
  return (
    <section className="flex w-full flex-col gap-4 mt-10 bg-white bg-opacity-15 p-5 justify-center border-2 rounded-lg">
      ...
      <div className="flex text-3xl min-[895px]:text-5xl gap-y-16 font-mono justify-between flex-wrap max-[560px]:flex-col max-[560px]:justify-center items-center max-[560px]:text-5xl">
